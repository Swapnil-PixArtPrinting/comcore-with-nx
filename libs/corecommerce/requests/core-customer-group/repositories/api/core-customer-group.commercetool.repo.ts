...
@Injectable()
export class CommercetoolCustomerGroupRepository implements CommerceCustomerGroupRepository {
    ...
    async fetchCustomerGroupByKey(customerGroupKey: string): Promise<CustomerGroupModel | null> {
        ...
        return customeGroupDataCollection.body && Object.keys(customeGroupDataCollection.body).length > 0 ? customeGroupDataCollection.body : null;
    }
}