...
@Injectable()
export class CommerceCustomerGroupServiceImpl
  implements CommerceCustomerGroupService
{
  constructor(
  ...
  async fetchCustomerGroupByKey(
    ...
    return await this.commerceCustomerGroupRepository.repository.fetchCustomerGroupByKey(
      customerGroupKey,
    );
  }
}
