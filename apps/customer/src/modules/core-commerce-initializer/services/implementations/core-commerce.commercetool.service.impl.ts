...
import { CoreCommerceConfigService } from '@app/common';
import { CoreConfigService } from '@app/corecommerce';
  ...
  implements ICoreCommerceInitializerService
{
  ...
  async initialize() {
    ...
    await this.coreConfigService.setCoreCommerceConfig(
      coreCommerceConfig as any,
    );
