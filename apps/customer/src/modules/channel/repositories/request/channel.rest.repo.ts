...
import { ChannelModel, CommerceChannelServiceFactory } from '@comcore/ocs-lib-corecommerce';

@Injectable()
export class ChannelRestRepository implements IChannelRepository {
  constructor(private readonly commerceChannelService: CommerceChannelServiceFactory) {}
  ...
  async fetchChannelByKey(channelKey: string): Promise<ChannelModel | null> {
    return await this.commerceChannelService.service.fetchChannelByKey(channelKey);
  }
